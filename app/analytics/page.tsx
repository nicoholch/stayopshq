...
// ── Rich demo dataset — 90 days, realistic distribution ──────────────────────
...
export default async function AnalyticsPage() {
  if (!SUPABASE_CONFIGURED) {
    return <AnalyticsClient complaints={DEMO_COMPLAINTS} />;
  }
  ...
  // Fetch all complaints — analytics needs full history
  ...
  return <AnalyticsClient complaints={shaped as unknown as Complaint[]} />;
}
