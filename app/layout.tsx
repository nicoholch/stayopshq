...
export const metadata: Metadata = {
  // Core
  title: {
    default: 'PulseStay — Real-Time Guest Feedback for 5-Star Hotels',
    template: '%s | PulseStay',   // Page titles become "Dashboard | PulseStay"
  },
  description:
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL ?? 'https://pulsestay.com'),

  // Open Graph — controls how links look when shared on Slack, LinkedIn, iMessage, etc.
  openGraph: {
    type: 'website',
    siteName: 'PulseStay',
    title: 'PulseStay — Real-Time Guest Feedback for 5-Star Hotels',
    description:
      'Most hotels capture only 10% of guest feedback. PulseStay captures 30%+ by meeting guests in the moment.',
    url: '/',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'PulseStay dashboard showing live guest feedback',
      },
    ],
  },
  ...
  twitter: {
    ...
    title: 'PulseStay — Real-Time Guest Feedback',
